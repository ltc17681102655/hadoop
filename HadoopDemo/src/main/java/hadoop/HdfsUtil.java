...
//		fs = FileSystem.get(new URI("hdfs://www.memory3334.com:50070/"), conf, "xmy");
		fs = FileSystem.get(new URI("hdfs://39.106.208.40:9000/"), conf,"Administrator");
	...
	public static void main1(String[] args) throws IOException {
		...
		Path dts = new Path("hdfs://39.106.208.40:9000/data.txt");
		FSDataOutputStream os = fs.create(dts);
//		FileInputStream is = new FileInputStream("/Users/xmy/Desktop/data.txt");
		FileInputStream is = new FileInputStream("C:\\Users\\Administrator\\Desktop\\密码.txt");
